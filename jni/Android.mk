...
LOCAL_SRC_FILES := \
		$(BASE)/src/MaiAT3PlusCoreDecoder.cpp \
		$(BASE)/src/MaiAT3PlusCoreDecoder_DecFunc.cpp \
		$(BASE)/src/MaiAT3PlusCoreDecoder_StaticData.cpp \
		$(BASE)/src/MaiAT3PlusCoreDecoder_SubFunc.cpp \
		$(BASE)/src/MaiAT3PlusFrameDecoder.cpp \
