...
extern Mai_I16 *MAPCDSD_table_static_0;
extern float *MAPCDSD_table_static_1;
extern float *MAPCDSD_table_static_2;
extern float *MAPCDSD_table_static_3;
extern float *MAPCDSD_table_static_4;
extern float *MAPCDSD_table_static_5;
extern float *MAPCDSD_table_static_6;
extern float MAPCDSD_table_sin0[];
extern float MAPCDSD_table_cos0[];
extern float MAPCDSD_table_sin1[];
extern float MAPCDSD_table_cos1[];

Mai_Status MAPCDDF_initMDataTable(MaiAT3PlusCoreDecoderChnInfo **chn_infos, float **pptablef0, Mai_U32 chns)
{
	Mai_Status rs = 0;

	Mai_U32 table_tmp0_o[] = {0x00000000, 0x3F3F7E00, 0x3EE5CC00, 0x3EA42400, 0x3E50E600, 0x3E193200, 0x3D944200, 0x3D11E600};
	float *table_tmp0 = (float *)table_tmp0_o;
	Mai_U32 table_tmp1_o[] = {0x3CE42A00, 0x3D0FBC00, 0x3D351800, 0x3D642A00, 0x3D8FBC00, 0x3DB51800, 0x3DE42A00, 0x3E0FBC00, 0x3E351800, 0x3E642A00, 0x3E8FBC00, 0x3EB51800, 0x3EE42A00, 0x3F0FBC00, 0x3F351800, 0x3F642A00, 0x3F8FBC00, 0x3FB51800, 0x3FE42A00, 0x400FBC00, 0x40351800, 0x40642A00, 0x408FBC00, 0x40B51800, 0x40E42A00, 0x410FBC00, 0x41351800, 0x41642A00, 0x418FBC00, 0x41B51800, 0x41E42A00, 0x420FBC00, 0x42351800, 0x42642A00, 0x428FBC00, 0x42B51800, 0x42E42A00, 0x430FBC00, 0x43351800, 0x43642A00, 0x438FBC00, 0x43B51800, 0x43E42A00, 0x440FBC00, 0x44351800, 0x44642A00, 0x448FBC00, 0x44B51800, 0x44E42A00, 0x450FBC00, 0x45351800, 0x45642A00, 0x458FBC00, 0x45B51800, 0x45E42A00, 0x460FBC00, 0x46351800, 0x46642A00, 0x468FBC00, 0x46B51800, 0x46E42A00, 0x470FBC00, 0x47351800, 0x47642A00};
	float *table_tmp1 = (float *)table_tmp1_o;

	Mai_U32 table_search0[] = {0, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0xa0, 0xc0, 0xe0, 0x100, 0x120, 0x140, 0x160, 0x180, 0x1c0, 0x200, 0x240, 0x280, 0x2c0, 0x300, 0x380, 0x400, 0x480, 0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800};
	Mai_U32 table_search1[] = {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80};
	...
	if (chns == 2)
	{
		for (Mai_U32 a0 = 0; a0 < chn_infos[0]->joint_chn_info->num_band_used; a0++)
		{
			...
			{
				Mai_U8 table_tmp7[] = {0x00, 0x08, 0x0C, 0x10, 0x12, 0x14, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20};
		...
		if (1)
		{
			for (Mai_I32 a00 = 0; a00 < chns; a00++)
			{
...

				{
					...
					for (Mai_I32 a0 = 0; a0 < 0x80; a0++)
					{
						float table_626a90[] = {1.997591f, 1.978353f, 1.940063f, 1.883088f, 1.807979f, 1.715457f, 1.606415f, 1.481902f, 1.343118f, 1.191399f, 1.028206f, 0.8551102f, 0.6737797f, 0.4859604f, 0.2934610f, 0.09813535f};
						float table_626af0[] = {1.961571f, 1.662939f, 1.111140f, 0.3901806f};
						float table_626ae0[] = {1.268787f, 0.9427935f, 0.5805694f, 0.1960343f};
						float table_626ad0[] = {1.990369f, 1.913881f, 1.763843f, 1.546021f};
						float stmp140[0x10];
						float stmp30[0x100];
						...
						Mai_U32 table_5b4050[] = {0x00000000, 0x00000010, 0x00000020, 0x00000008, 0x00000018, 0x00000028, 0x00000018, 0x00000028, 0x00000008, 0x00000007, 0x00000017, 0x00000027, 0x0000001F, 0x0000002F, 0x0000000F, 0x0000000F, 0x0000001F, 0x0000002F, 0x00000020, 0x00000000, 0x00000010, 0x00000000};
						...
						float table_5b3ed0[] = {1.672582e-05f, 2.934863e-05f, 3.487291e-05f, 7.567905e-06f};
						float table_5b3ee0[] = {-8.893659e-06f, -1.682840e-05f, -1.481585e-05f, 0.0003469118f};
						float table_5b3d50[] = {-1.866759e-05f, -2.579335e-05f, -1.344173e-05f, -1.420818e-06f};
						float table_5b3d60[] = {1.032399e-06f, 1.129874e-06f, 4.051321e-07f, 0.0003365371f};
